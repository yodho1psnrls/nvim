...
return {
  -- https://www.reddit.com/r/neovim/comments/17sq6hu/forking_symbolsoutlinenvim/
  { -- NOTE: Successor/Fork of simrat39/symbols-outline.nvim
  ...
  -- NOTE: Deprecated(Archived plugin) !
  --[[{
